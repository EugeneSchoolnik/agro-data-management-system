...
func (_m *SensorService) Delete(id int) error {
	ret := _m.Called(id)
...
// GetByField provides a mock function with given fields: fieldID
func (_m *SensorService) GetByField(fieldID int) ([]models.Sensor, error) {
...
func (_m *SensorService) GetByID(id int) (models.Sensor, error) {
	ret := _m.Called(id)
...
func (_m *SensorService) UpdateStatus(id int, status models.SensorStatus) error {
